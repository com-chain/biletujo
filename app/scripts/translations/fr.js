...
HELP_2: 'Aide Contenu du portefeuille',

PDF_Private_title: 'Votre Portefeuille',
...
GEN_Enrollment_KO: 'Le serveur n\'est pas disponible ou a refusé la création de votre portefeuille.',
...
GEN_Warning_2: 'Attention: Si vous perdez votre clef privée, les montants contenus dans ce portefeuille seront perdus.', 
GEN_OK: 'OK',
...
GEN_LostPass: 'J\'ai bien compris que si je perds mon mot de passe ou mon fichier de sauvegarde (clef privée), je ne serai plus en mesure d\'utiliser les montants liés à ce portefeuille.',
GEN_Create: 'Créer',
...
Acc_locked: 'Attention: ce portefeuille est actuellement bloqué.',

/* View Wallet*/
VIEW_address: 'Votre portefeuille',
...
DCRY_Close_Wrn: 'Attention! : Si vous fermez un portefeuille sans avoir effectué une copie de sauvegarde, il sera perdu (ainsi que les montants qu\'il contient)',
DCRY_Close_conf: 'J\'ai une sauvegarde. Je veux fermer ce portefeuille.',
DCRY_Close_cancel: 'Garder ce portefeuille ouvert.',
DCRY_Missing_server: 'Il n\'y a pas de server associé à ce portefeuille. Veuillez entrer votre code d\'autorisation. (Pensez à refaire une sauvegarde de ce portefeuille)',

/*Transaction*/
TRAN_Address: 'Votre portefeuille',
TRAN_Solde: 'Solde:',
...
TRAN_MyAccount:'Ce portefeuille',
TRAN_MyDelegations:'Un autre portefeuille',
...
DELEG_Delegate_Help_text:'Une procuration donne l\'autorisation à un tiers d\'effectuer des paiements en votre nom vers un autre portefeuille. La limite d\'une procuration est la somme maximum qui peut être engagée par transaction.',
DELEG_Close:'Fermer',
...
ALLOW_Allowance_Help_text:'Une autorisation de débit (débit direct) donne le droit à la personne autorisée de prélever une somme sur votre portefeuille à hauteur du montant que vous avez spécifié. Au-delà de cette limite, vous recevrez une demande de confirmation pour le paiement demandé.',
ALLOW_Close:'Fermer',
...
TRA_next: '>',
TRA_check: '&#x2714;',
TRA_NoTrans: 'Aucune transaction associée à ce portefeuille.',
...
TRA_Approval_Help_text: 'Cette page liste les demandes de paiement qui vous sont adressées et que vous n\'avez pas encore traitées.\n Une demande de paiement est générée: \n 1. soit lorsqu\'un utilisateur demande un versement de votre part vers son portefeuille (facture), \n 2. soit en cas d’autorisation de votre part, lorsque le montant demandé dépasse celui de l\'autorisation. \n Vous pouvez refuser la transaction: celle-ci disparaît alors de la liste. Si vous acceptez la demande, le paiement est effectué, le montant correspondant est débité de votre portefeuille et la transaction apparaît (une fois traitée) dans la liste des transactions.',
...
CTC_export: '&#x1f4be;',
CTC_import:  '&#x1f4c2;',
CTC_Export: 'Exporter les contacts',
...
CTC_Merge_mine: 'Conserver les locaux ',
...
CTC_no_valid_ctc: 'Ce fichier ne contient pas de contact valide.',
...
CTC_NotSameCurrTxt: 'Ce contact est associé à une autre monnaie que votre portefeuille. Il ne peut donc pas être choisi comme destinataire d\'un payement.',
...
STR_No: 'Non',
STR_Yes: 'Oui',
STR_logout: 'Pour votre sécurité, une fois votre session terminée veuillez: \n1. Verrouiller votre portefeuille et revenir sur cette page. \n2. Vous assurer que vous avez un fichier de sauvegarde de votre portefeuille sur un autre support que le disque dur de cet ordinateur. \n3. Eliminer les copies du fichier de sauvegarde de cet ordinateur (si vous avez sauvegardé votre portefeuille durant cette session, vérifiez le dossier "Téléchargement"). \n4. Vider la mémoire du navigateur en cliquant sur le bouton ci-dessous. \n5. Vider le cache du navigateur.',
STR_Clear: 'Vider la mémoire',
STR_NoWallet: 'Pas de portefeuille',
STR_confirmDelete: 'Supprimer ce portefeuille de la mémoire',
STR_warning: 'Attention vous devez conserver un fichier de sauvegarde pour pouvoir réouvrir votre portefeuille. Si ce n\'est pas déjà fait vous pouvez faire une sauvegarde ci-dessous',
